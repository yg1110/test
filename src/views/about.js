      ...
      <div class="introduction-content">
        <div class="introduction-body">
          ...
          <div class="introduction-answer">
            ...
            Front-End Developer의 역량을 키웠습니다.</h4>
          </div>
        </div>
        ...
        <div class="introduction-body">
          ...
          <div class="introduction-answer">
            <h4>빠른성장, 오로지 나만의 코드를 작성할 수 있다는것<br>
            ...
            서로에게 도움과 의지를 할 수 있는 개발분위기를 좋아하기 때문에 스타트업에 지원을 하게 되었습니다.</h4>
          </div>
        </div>
        ...
        <div class="introduction-body">
          ...
          <div class="introduction-answer">
            ...
            어떤식으로 짜야될 것인지를 정하고 그 계획을 바탕으로 코드를 작성하기 시작합니다.</h4>
          </div>
        </div>
      </div>
    </div>
